...
List, register, and delete branch custom domains: `list_functions_custom_domains`, `register_functions_custom_domains`, `delete_functions_custom_domains` (`?category=functions`). Requires `@neon/tools` 1.2.0.
