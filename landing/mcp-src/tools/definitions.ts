...
export const NEON_TOOLS = [
  ...
  },
  {
    ...
    - add_oauth_provider: enable an OAuth provider (google/github/microsoft/vercel) on this branch. Pass the provider id via "oauth_provider". Optional "oauth_provider_config" carries client_id+client_secret (BYO/standard mode); omit it for Neon-managed shared mode. For Microsoft, optionally also pass microsoft_tenant_id.
